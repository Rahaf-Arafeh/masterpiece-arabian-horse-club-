                                    ...
                                    <div class="card-body">
                                        ...
                                        @csrf
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="inputFirstName" type="text" placeholder="Enter course name" name="course_name"  />
                                                        <label for="inputFirstName">Course name</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="inputLastName" type="text" placeholder="Enter price" name="course_desc"  />
                                                        <label for="inputLastName">Course Description</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" type="text" placeholder="Enter description" name="course_trainer"  />
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3">
                                                        <input class="form-control" id="inputPasswordConfirm" type="text" placeholder=" bed type" name="course_period" />
                                                        <label for="inputPasswordConfirm">Course period</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3">
                                                        <input class="form-control" id="inputPasswordConfirm" type="date" placeholder="services" name="course_date" />
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><button type="submit">Create Course</button></div>
                                            </div>
                                        </form>
                                    </div>
